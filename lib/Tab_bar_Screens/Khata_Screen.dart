...
import 'package:untitled1/Tab_bar_Screens/supplier_screen.dart';
...
class Khata_Screen extends StatefulWidget {
  const Khata_Screen({Key? key}) : super(key: key);

  @override
  _Khata_ScreenState createState() => _Khata_ScreenState();
}

class _Khata_ScreenState extends State<Khata_Screen> {
  int _counter = 0;
...
class khata_main extends StatelessWidget {
  const khata_main({Key? key}) : super(key: key);
